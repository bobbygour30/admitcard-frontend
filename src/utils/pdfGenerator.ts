    ...
    <div style="border: 1px solid #000; padding: 8mm; border-radius: 5px; height: calc(100% - 16mm);">
      ...
      <div style="margin: 0;">
        ...
        <div style="display: flex; margin-bottom: 4mm;">
          ...
          <span style="flex: 1; text-align: justify;">
            For any query or clarification please email at <a href="mailto:writetogsgspl@gmail.com">writetogsgspl@gmail.com</a> or Call/WhatsApp at ${data.union === "Tirhut Union" ? "9472596352" : "01169270767"}.
          </span>
        </div>
      </div>
    </div>
